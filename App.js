...
const styles = StyleSheet.create({
  ...
  /*contenedor:{
    ...
    flex:1,//crecer ancho y alto
    //por default la direccion de flexbox es column
    flexDirection:'row',//column row column-reverse row-reverse
    justifyContent:'center',//'center,flex-start,flex-end,space-btween,
    alignItems:'center'
  },*/
  /* se dividen en tamanis iguales
  caja1:{
    padding: 20,
